...
23. [Find Pairs with Given Sum in Linked List](/linked-list/19_CountPairIn_LL.java)
24. [Find Pairs with Given Sum in Doubly Linked List](/linked-list/20_CountPairIn_DLL.java)
25. [Count Triplets in a Sorted Doubly Linked List Whose Sum is Equal to a Given Value X](/linked-list/22CountTripletsInDLL.java)
26. [Count Triplets in a Linked List Whose Sum is Equal to a Given Value X](/linked-list/21CountTripletsInLL.java)
27. [Clone List with Next and Random](/linked-list/27-Clone-LL-with-Next-and-Random.java)
28. [Merge K sorted Linked List](/linked-list/30-Merge-K-sorted-LL.java)
29. [Sort the given doubly linked list where each node is at most k-indices away from its target position](/linked-list/23SortKSortedDLL.java)
30. [Binary Tree to DLL](/linked-list/26-Binary-Tree-to-DLL.java)
